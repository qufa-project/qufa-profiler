...
import com.QuFa.profiler.domain.request.DependencyAnalysis;
import com.QuFa.profiler.domain.request.FKAnalysis;
import com.QuFa.profiler.domain.request.Profiles;
import com.QuFa.profiler.domain.response.BasicProfile;
import com.QuFa.profiler.domain.response.DateProfile;
import com.QuFa.profiler.domain.response.DependencyAnalysisResult;
import com.QuFa.profiler.domain.response.FKAnalysisResult;
import com.QuFa.profiler.domain.response.NumberProfile;
import com.QuFa.profiler.domain.response.ProfileColumnResult;
import com.QuFa.profiler.domain.response.ProfileTableResult;
import com.QuFa.profiler.domain.response.StringProfile;
import com.QuFa.profiler.domain.response.VdModel;
